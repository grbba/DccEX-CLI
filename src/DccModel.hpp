...
// Generated by https://dccexlayout.io
...
namespace nlohmann {
    inline void from_json(const json& _j, dccexlayout::From& _x) {
        _x.set_from_module( _j.at("module").get<std::string>() );
        _x.set_path( _j.at("path").get<int64_t>() );
    }

    inline void to_json(json& _j, const dccexlayout::From& _x) {
        _j = json::object();
        _j["module"] = _x.get_from_module();
        _j["path"] = _x.get_path();
    }

    inline void from_json(const json& _j, dccexlayout::To& _x) {
        _x.set_to_module( _j.at("module").get<std::string>() );
        _x.set_path( _j.at("path").get<int64_t>() );
    }

    inline void to_json(json& _j, const dccexlayout::To& _x) {
        _j = json::object();
        _j["module"] = _x.get_to_module();
        _j["path"] = _x.get_path();
    }

    inline void from_json(const json& _j, dccexlayout::Junction& _x) {
        _x.set_from( _j.at("from").get<dccexlayout::From>() );
        _x.set_to( _j.at("to").get<dccexlayout::To>() );
    }

    inline void to_json(json& _j, const dccexlayout::Junction& _x) {
        _j = json::object();
        _j["from"] = _x.get_from();
        _j["to"] = _x.get_to();
    }

    inline void from_json(const json& _j, dccexlayout::Layout& _x) {
        _x.set_author( dccexlayout::get_optional<std::string>(_j, "author") );
        _x.set_description( dccexlayout::get_optional<std::string>(_j, "description") );
        _x.set_name( _j.at("name").get<std::string>() );
        _x.set_version( _j.at("version").get<std::string>() );
    }

    inline void to_json(json& _j, const dccexlayout::Layout& _x) {
        _j = json::object();
    ...
    inline void from_json(const json& _j, dccexlayout::Module& _x) {
        _x.set_description( dccexlayout::get_optional<std::string>(_j, "description") );
        _x.set_name( _j.at("name").get<std::string>() );
        _x.set_trackplan( _j.at("trackplan").get<std::string>() );
    }

    inline void to_json(json& _j, const dccexlayout::Module& _x) {
        _j = json::object();
        _j["description"] = _x.get_description();
        _j["name"] = _x.get_name();
    ...
    inline void from_json(const json& _j, dccexlayout::Bumper& _x) {
        _x.set_description( dccexlayout::get_optional<std::string>(_j, "description") );
        _x.set_path( _j.at("path").get<int64_t>() );
    }

    inline void to_json(json& _j, const dccexlayout::Bumper& _x) {
        _j = json::object();
        _j["description"] = _x.get_description();
        _j["path"] = _x.get_path();
    }

    inline void from_json(const json& _j, dccexlayout::Crossing& _x) {
        _x.set_description( dccexlayout::get_optional<std::string>(_j, "description") );
    ...
    inline void to_json(json& _j, const dccexlayout::Crossing& _x) {
        _j = json::object();
        _j["description"] = _x.get_description();
    ...
    inline void from_json(const json& _j, dccexlayout::Rail& _x) {
        _x.set_description( dccexlayout::get_optional<std::string>(_j, "description") );
        _x.set_length( _j.at("length").get<int64_t>() );
        _x.set_path( _j.at("path").get<std::vector<int64_t>>() );
    }

    inline void to_json(json& _j, const dccexlayout::Rail& _x) {
        _j = json::object();
        _j["description"] = _x.get_description();
        _j["length"] = _x.get_length();
        _j["path"] = _x.get_path();
    ...
    inline void from_json(const json& _j, dccexlayout::Turnout& _x) {
        _x.set_description( dccexlayout::get_optional<std::string>(_j, "description") );
        _x.set_length( _j.at("length").get<int64_t>() );
    ...
    inline void to_json(json& _j, const dccexlayout::Turnout& _x) {
        _j = json::object();
        _j["description"] = _x.get_description();
        _j["length"] = _x.get_length();
    ...
    inline void from_json(const json& _j, dccexlayout::Trackelement& _x) {
        _x.set_bumper( dccexlayout::get_optional<dccexlayout::Bumper>(_j, "bumper") );
        _x.set_rail( dccexlayout::get_optional<dccexlayout::Rail>(_j, "rail") );
        _x.set_turnout( dccexlayout::get_optional<dccexlayout::Turnout>(_j, "turnout") );
        _x.set_crossing( dccexlayout::get_optional<dccexlayout::Crossing>(_j, "crossing") );
    }

    inline void to_json(json& _j, const dccexlayout::Trackelement& _x) {
        _j = json::object();
    ...
    inline void from_json(const json& _j, dccexlayout::Tracksection& _x) {
        _x.set_name( _j.at("name").get<std::string>() );
        _x.set_trackelements( _j.at("trackelements").get<std::vector<dccexlayout::Trackelement>>() );
    }

    inline void to_json(json& _j, const dccexlayout::Tracksection& _x) {
        _j = json::object();
        _j["name"] = _x.get_name();
        _j["trackelements"] = _x.get_trackelements();
    }

    inline void from_json(const json& _j, dccexlayout::Trackplan& _x) {
        _x.set_description( dccexlayout::get_optional<std::string>(_j, "description") );
        _x.set_name( _j.at("name").get<std::string>() );
        _x.set_tracksections( _j.at("tracksections").get<std::vector<dccexlayout::Tracksection>>() );
    }

    inline void to_json(json& _j, const dccexlayout::Trackplan& _x) {
        _j = json::object();
        _j["description"] = _x.get_description();
        _j["name"] = _x.get_name();
    ...
    inline void from_json(const json& _j, dccexlayout::DccExLayout& _x) {
        _x.set_junctions( dccexlayout::get_optional<std::vector<dccexlayout::Junction>>(_j, "junctions") );
        _x.set_layout( _j.at("layout").get<dccexlayout::Layout>() );
        _x.set_modules( _j.at("modules").get<std::vector<dccexlayout::Module>>() );
        _x.set_trackplans( _j.at("trackplans").get<std::vector<dccexlayout::Trackplan>>() );
        _x.set_schema( dccexlayout::get_untyped(_j, "$schema") );
    }

    inline void to_json(json& _j, const dccexlayout::DccExLayout& _x) {
        _j = json::object();
