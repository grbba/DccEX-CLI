...
//
//     DccExLayout data = nlohmann::json::parse(jsonString);
...
namespace DccModel {
    ...
    class Junction : public DccObject{
         ...
         * From connection
         */
        From const & get_from() const { return from; }
        From & get_mutable_from() { return from; }
        void set_from(From const & value) { this->from = value; }

        /**
         * To connection
         */
        To const & get_to() const { return to; }
        To & get_mutable_to() { return to; }
        void set_to(To const & value) { this->to = value; }
    };
    ...
    class Tracksection : public DccObject{
         ...
         */
        std::vector<Trackelement> const & get_trackelements() const { return trackelements; }
        std::vector<Trackelement> & get_mutable_trackelements() { return trackelements; }
        void set_trackelements(std::vector<Trackelement> const & value) { this->trackelements = value; }
    };
    ...
    class Trackplan : public DccObject{
         ...
         * track section
         */
        std::vector<Tracksection> const & get_tracksections() const { return tracksections; }
        std::vector<Tracksection> & get_mutable_tracksections() { return tracksections; }
        void set_tracksections(std::vector<Tracksection> const & value) { this->tracksections = value; }
    };
    ...
    class DccExLayout {
        ...
        void set_layout(Layout const & value) { this->layout = value; }
        ...
        void set_modules(std::vector<Module> const & value) { this->modules = value; }

        /**
         * List of available trackplans
         */
        std::vector<Trackplan> const & get_trackplans() const { return trackplans; }
        std::vector<Trackplan> & get_mutable_trackplans() { return trackplans; }
        void set_trackplans(std::vector<Trackplan> const & value) { this->trackplans = value; }

        nlohmann::json const & get_schema() const { return schema; }
        nlohmann::json & get_mutable_schema() { return schema; }
        void set_schema(nlohmann::json const & value) { this->schema = value; }
    };
}
